...
I believe we're almost there.  The (hopefully final) problem that remains is a link error encountered when linking the final product to be built. I'm guessing there is a missing file somewhere in the link arguments. Output follows:
