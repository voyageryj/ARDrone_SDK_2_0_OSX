...
#if defined(__linux__) || defined (__elinux__) || defined(TARGET_OS_ANDROID) || defined(TARGET_OSX)
...
#if defined(USE_MINGW32) || defined(TARGET_OS_IPHONE) || defined(TARGET_OS_IPHONE_SIMULATOR)

#define MSG_NOSIGNAL 0

#define CYGPKG_NET 1
#endif // USE_MINGW32 || TARGET_OS_IPHONE || TARGET_OS_IPHONE_SIMULATOR
