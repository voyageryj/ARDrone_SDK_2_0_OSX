...
all $(MAKECMDGOALS):
	...
	@echo
	@echo GENERIC_LIBRARY_TARGET_DIR == $(GENERIC_LIBRARY_TARGET_DIR)
	@echo GENERIC_TARGET_LIBRARY == $(GENERIC_TARGET_LIBRARY)
	@echo GENERIC_INCLUDES == $(GENERIC_INCLUDES)
	@echo GENERIC_LIBRARY_SOURCE_DIR == $(GENERIC_LIBRARY_SOURCE_DIR)
	@echo GENERIC_LIBRARY_SOURCE_FILES == $(GENERIC_LIBRARY_SOURCE_FILES)
	@echo "--------------------------------------------------"
